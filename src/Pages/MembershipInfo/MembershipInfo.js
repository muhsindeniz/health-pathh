...
const MembershipInfo = () => {
    ...
    return (
        <>
            ...
            {
                showAddressPopup && <AddUserAddress setAddressInfo={setAddressInfo} addressInfo={addressInfo} setShowAddressPopup={setShowAddressPopup} />
            }
                                        ...
                                        <TabPane tab="Communication preferences" key="3" className="mt-5">
                                            <div className="row d-flex justify-content-center">
                                                <div className="col-sm-12 col-lg-8">
                                                    ...
                                                    <section className="card cursor-pointer" onClick={() => setShowAddressPopup(true)}>
